        ...
        <div className="session-wrapper">
            ...
            <Fade direction='down' fraction={0.3}>
                <div className="about">
                    ...
                    <span className="bio">I am in my final year of a Computer Science degree at the <a href='https://internacional.ufrj.br/en/study-at-ufrj' target="_blank" rel='noreferrer' className='orange'>Universidade Federal do Rio de Janeiro (UFRJ)</a>, one of Brazil's leading universities. Concurrently, I am a software engineer intern at <a href='https://bigdatacorp.com.br/sobre-a-bigdatacorp' target="_blank" rel='noreferrer' className='orange'>BigDataCorp</a> and contribute to scientific projects with <strong className='orange'>COPPETEC</strong> and <strong className='orange'>UFRJ</strong>, where I tackle challenges in data management and educational technology.</span>
